            ...
            <div class="row">
                <div class="col">
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('servis.update', $servis->id_servis) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label class="form-label">ID Servis</label>
                                    <input type="number" class="form-control @error('id_servis') is-invalid @enderror" name="id_servis" value="{{ old('id_servis', $servis->id_servis) }}" placeholder="Input ID Servis">
                                    @error('id_servis')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_servis') is-invalid @enderror" name="jenis_servis" value="{{ old('jenis_servis', $servis->jenis_servis) }}" placeholder="Input Jenis Servis">
                                    @error('jenis_servis')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_servis') is-invalid @enderror" name="tanggal_servis" value="{{ old('tanggal_servis', $servis->tanggal_servis) }}" placeholder="Input Tanggal Servis">
