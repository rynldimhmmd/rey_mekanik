...
<head>
    ...
    <title>ReyLab - Show Mekanik</title>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <h3>ID Mekanik: {{ $mekaniks->id_mekanik }}</h3>
                            <hr/>
                            <p>ID Servis: {{ $mekaniks->id_servis }}</p>
                            <p>Nama Mekanik: {{ $mekaniks->nama }}</p>
                            <p>Alamat Mekanik: {{ $mekaniks->alamat }}</p>
                            <p>No Telp: {{ $mekaniks->notelp }}</p>
                            <hr/>
                            <p>Dibuat pada: {{ $mekaniks->created_at }}</p>
                        </div>
                    </div>
                </div>
            </div>
